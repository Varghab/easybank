        ...
        <Box sx={{boxSizing:'border-box',position:'relative',flexWrap:'wrap', display:'flex', justifyContent:'space-between',alignItems:'center',maxWidth:'1200px', width:'100%',marginInline:'auto', p:{md:'0',xs:'1rem 1.5rem'}}}>
            ...
            <Box sx={{display:{md:'block', xs:'none'}}}>
                <List sx={{display:'flex'}}>
                    <ListItem>
                        <ListItemText className='navItem' sx={{color:'#b8b8b8',cursor:'pointer'}} primary='Home' />
                    </ListItem>
                    <ListItem>
                        <ListItemText className='navItem' sx={{color:'#b8b8b8',cursor:'pointer'}} primary='About' />
                    </ListItem>
                    <ListItem>
                        <ListItemText className='navItem' sx={{color:'#b8b8b8',cursor:'pointer'}} primary='Contact' />
                    </ListItem>
                    <ListItem>
                        <ListItemText className='navItem' sx={{color:'#b8b8b8',cursor:'pointer'}} primary='Blog' />
                    </ListItem>
                    <ListItem>
                        <ListItemText className='navItem' sx={{color:'#b8b8b8',cursor:'pointer'}} primary='Careers' />
                    </ListItem>
                </List>
            </Box>
