...
const Hero = () => {
    return (
        <Box component='heading' sx={{marginInline:'auto',pt:'3rem'}}>
            <Box sx={{maxWidth:'1200px',minHeight:{md:'90vh',xs:'auto'},marginInline:'auto', flexDirection:{md:'row',xs:'column-reverse'},display:'flex', alignItems:'center', flexWrap:'wrap',position:'relative'}}>
                <Box sx={{display:'flex',flexDirection:'column',maxWidth:'450px', width:'90%', mt:{md:'0',xs:'2rem'}, mb:'1rem',textAlign:{md:'left',xs:'center'}}}>
                    ...
                    <Typography variant='h2' sx={{fontWeight:'300', lineHeight:'2',fontSize:{md:'1rem',xs:'.9rem'}, color:'hsl(233, 8%, 62%)',mt:'20px'}}>
                ...
                <Box role='img' alt='Mobile Phones showing data' component='img' src={HeroUp} sx={{width:{md:'40rem',xs:'50%'},minWidth:'15rem',position:{md:'absolute',xs:'static'},right:-210, top:-40, zIndex:'0', maxWidth:"700px"}}></Box>
            </Box>
        </Box>
    )
}
